...
android {
    namespace = "com.kenshi.kmmtranslator.android"
    compileSdk = 33
    defaultConfig {
        applicationId = "com.kenshi.kmmtranslator.android"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.kenshi.kmmtranslator.TestHiltRunner"
    }
    buildFeatures {
        compose = true
    }
